...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        gradient.type = .axial
        gradient.colors = [UIColor.init(cgColor: .init(srgbRed: 300, green: 138, blue: 216, alpha: 100)), UIColor.white.cgColor]
    ...
    func showCreateAccount(email: String, password: String) {
        let alert = UIAlertController(title: "Don't have one? Create New Account", message: "Would you like to create an account", preferredStyle: .alert)
